...
?>
<div class="row">
    <div class="col-lg-12">На этой странице Вы можете управлять разделами с товарами Вашего магазина для участия в контекстной рекламе.
                ...
                <form method="post" action="/context-adv/process">
                    ...
                    <div class='mydiv'>
                        <table class="table table-bordered table-striped table-condensed">
                            <tr>
                                <th style="width:20px">Вкл. <input type='checkbox' id="all_check" name='all_checked_rule' onclick='check_all(this.checked)' /></th>
                                <th>Раздел</th>
                                <th>&nbsp;</th>
                            </tr>
                            <?= isset($data) ? $data : "" ?>
