                    ...
                    <?php if (isset($f_offerta) && ((int)$f_offerta & 1)): ?>
                        ...
                        <div id="text_nds">
                            ...
                            <p>ООО «Марталь», УНП 192583317<br>
                                ...
                                БИК ALFABY2X в ЗАО «Альфа-Банк», Головной офис, код 270, ул. Сурганова, 43, 220013, г.Минск</p>
                        </div>
                    <?php endif; ?>
                    <br><br>
                    <?php if ((isset($f_offerta) && ((int)$f_offerta & 2))): ?>
                        <div id="text_no_nds">
                            ...
                            <p>ИНДИВИДУАЛЬНЫЙ ПРЕДПРИНИМАТЕЛЬ ШМЫК ОЛЕГ ДМИТРИЕВИЧ, УНП 191182046 <br>
								...
								р/с BY67 ALFA 3013 2619 0100 1027 0000 в BYN ЗАКРЫТОЕ АКЦИОНЕРНОЕ ОБЩЕСТВО &quot;АЛЬФА-БАНК&quot; БИК: ALFABY2X<br>                                
                                220013, Ул. Сурганова, 43-47, Минск, Республика Беларусь, </p>
                        </div>
                    <?php endif; ?>
                </div>
            </div>
