                ...
                <div class="col-lg-12">
                    <?php if (isset($f_offerta) && ((int)$f_offerta & 1)): ?>
                        ...
                        <div id="text_nds">
                            ...
                            <p>- через кассу банка путем внесения наличных денежных средств на расчетный счет ООО «Макси Бай Медиа»<br>
                                - через интернет-банкинг перевод по реквизитам путем перечесления денежных средств расчетный счет ООО «Макси Бай Медиа»</p>
                            ...
                            <p>ООО «Макси Бай Медиа»<br>
                                Юридический адрес: 220070, г. Минск, ул. Чеботарева, д. 7А, пом. 401<br>								
								р/с BY48ALFA30122544640010270000<br>
								в ЗАО «АЛЬФА-БАНК», код ALFABY2X,<br>
								адрес банка: 220013, г. Минск, ул. Сурганова 43-47.<br>
								УНП 191983656, ОКПО 381061785000;<br>
							</p>
                        </div>
                    <?php endif; ?>
                    <br><br>
                    <?php if ((isset($f_offerta) && ((int)$f_offerta & 2))): ?>
                        <div id="text_no_nds">
                            ...
                            <p>- в назначении платежа :<b> « id <?= $seller_id ?> оплата услуг по размещению рекламных материаловна сайте <?= \Yii::$app->params['migom_name'] ?> »;</b></p>
