    ...
    <div class="col-lg-6">
        <div class="card" style="height: 100%">
            <div class="card-block">
                <p>
                    «Обещанный платеж» — это возможность продлить срок размещения магазина на площадке Migom.by до внесения денежных средств на лицевой счет на максимальный срок — 3 дня.<br>
                    ...
                    По всем вопросам можете связаться с нами по тел. +375 (29) 111-45-45, +375 (29) 777-45-45.<br>
            ...
            <div class="card-block">
                ...
                <form class="form-inline">
                    <div class="input-group" style="width: 100%">
                        <input class="form-control" type="text" placeholder="Максимальная сумма <?= $day_down; ?> руб.">
