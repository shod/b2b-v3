        ...
        <div class="card ks-card-widget ks-widget-payment-table-invoicing">
            ...
            <div class="card-block">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <form class="form-inline" method="get">
                            <input id='date_from' class="form-control yes datepicker" name='date_from' type="text" maxlength="11" value='<?= isset($date_from) ? $date_from : ""?>' style="width:100px"/>
                            <input id='date_to' class="form-control yes datepicker" name='date_to' type="text" maxlength="11" value='<?= isset($date_to) ? $date_to: ""?>' style="width:100px"/>
