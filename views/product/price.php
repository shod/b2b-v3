...
<div class="row">
    <div class="col-lg-12">
        ...
        <div style="display: none;" id="help-block" class="alert alert-primary ks-solid-light" role="alert">
            ...
            <p>Для того чтобы скачать шаблон прайс-листа (шаблон прайс-листа для импорта на Migom.by с проставленными названиями товаров),
                нажмите на кнопку «Скачать шаблон прайса». Его можно скачать для всех товаров (только активные категории товаров),
                а также для отдельной категории.
            </p>
            <p>Скачанный шаблон можно заполнить и импортировать обратно.</p>
            <p>Если Вы хотите закачать свой прайс-лист, то выберите его на своем компьютере либо напишите ссылку на закачку прайс-листа с источника в интернете.
                Помните, что Ваш прайс-лист должен удовлетворять требованиям к прайс-листу для размещения на Migom.by.
            </p>
        </div>
    </div>
    <div class="col-lg-12">
        <div class="card" style="height: 100%">
            <div class="card-block">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8">
                        <a style="width: 100%" href='http://api.migom.by/api/price/csv/?seller_id=<?= $seller_id ?>&key_str=<?= $md5_seller ?>' target='_blank'>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8">
                        <a href='http://api.migom.by/api/price/yml/?seller_id=<?= $seller_id ?>&key_str=<?= $md5_seller ?>' target='_blank'>
    ...
    <div class="col-lg-12">
        <div class="card" style="height: 100%">
            <div class="card-block">
                ...
                <form class="form-inline" method="get" action="/product/price-template" id="frm_download_tmpl" >
        ...
        <div class="card" style="height: 100%">
            <div class="card-block">
                ...
                <div class="alert alert-primary ks-solid-light" role="alert">
                    ...
                    валюты в прайсе и в
                    <a class="alert-link" href='/?admin=settings&&action=options' target="_blank">настройках</a>.
                </div>

                <form method="post" action="/product/price-import" id="frm_import" enctype="multipart/form-data">
