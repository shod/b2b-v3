                ...
                <div class="col-lg-4 col-md-12 col-xs-12">
                    <div class="card ks-panel">
                        ...
                        <div class="card-block">
                            <p>Покупатель нажимает на кнопку «Заказать», расположенную рядом с вашими ценовыми предложениями. Заполняет данные для покупки, и заявка от покупателя приходит на ваш email.
                                <b>Не забудьте добавить email для заказов!</b>
                            </p>
                            <p>
                            Мы рекомендуем оперативно реагировать на заявки от покупателей.
                            Все заявки дублируются на странице Мои заказы в личном кабинете.
                            Отмечайте те, которые уже обработаны.
                            </p>
                            <p>
                            В течение 3-х суток можете оспорить отклоненную заявку.
                            Если вы не смогли связаться с покупателем для оформления заказа по каким-либо причинам, либо уверены, что заявка недействительна – нажимайте кнопку «Оспорить» и наш модератор обработает претензию. Если модератор подтверждает недействительность заявки, то списанные средства возвращаются на счет магазина в полном объеме.
