                            ...
                            <div class="ks-text-block">
                                ...
                                <div>
                                    <label class="ks-checkbox-switch ks-success">
                                        <input id="active-sms" type="checkbox" value="1" <?= isset($id_active) ? $id_active : "" ?> >
                                        <span class="ks-wrapper"></span>
                                        <span class="ks-indicator"></span>
                                        <span class="ks-on">Вкл</span>
                                        <span class="ks-off">Выкл</span>
                                    </label>
                                    <button class="btn btn-primary-outline ks-solid btn-block">Добавить 30 заказов за 9 ТЕ</button><br>
                                    <button class="btn btn-primary-outline ks-solid btn-block">Добавить 100 заказов за 19 ТЕ</button>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="card-block">
                <div class="ks-text-block">
                    ...
                    <div class="input-icon icon-left icon-lg icon-color-primary input-group">
                        <input id="phone-value" style="padding-left: 50px"  type="text" class="form-control"  placeholder="Номер" value="<?= isset($notice_phone) ? $notice_phone : "" ?>">
                        <span class="icon-addon">
                             <span>+375</span>
                        </span>
                        <span class="input-group-btn">
                                <button id="phone" class="btn btn-primary notify-button" type="button">Сохранить</button>
                        </span>
                    </div>
                ...
                <div class="ks-text-block">
                    ...
                    <div class="input-group">
                        <input id="email-value" type="text" class="form-control" placeholder="Email" value="<?= isset($notice_email) ? $notice_email : "" ?>">
                            <span class="input-group-btn">
