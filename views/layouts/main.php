            ...
            <div class="ks-wrapper ks-sidebar-wrapper">
                <ul class="nav nav-pills nav-stacked">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu">
                            <a class="dropdown-item" href="/tariff/<?= ($seller->pay_type) ?>">Мой тариф</a>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="#" data-remote="/site/ask" data-toggle="ajaxModal" data-target=".bd-example-modal-md">
