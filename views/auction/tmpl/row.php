<tr>
    ...
    <td style='width:60px' class="delete"><a style="color: red" href="<?= $href_delete ?>" title="Отказываюсь от участия"> <i class="la la-close la-2x do_delete" style="cursor: pointer"></i> </a></td>
</tr>