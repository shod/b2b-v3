<tr>
    ...
    <td style='width:100px' class="delete" align="center"><a style="color: red" href="<?= $href_delete ?>" title="Отказываюсь от участия"> <i class="fa fa-times-circle do_delete" style="cursor: pointer"></i> </a></td>
</tr>