<tr>
    ...
    <td colspan="2">
        <div class="row">
            ...
            <div class="col-lg-10"><button style="margin-top: 5px" class='btn btn-primary ks-light' data-remote="/auction/process/?action=get_arch&baid=<?= $catalog_id ?>" data-toggle="ajaxModal" data-target=".bd-example-modal-lg">Аукцион вчера</button></div>
        </div>
    </td>
