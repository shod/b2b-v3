                                    ...
                                    <td style="vertical-align: top;">
                                        <div class="btn-group" data-toggle="buttons"
                                            ...
                                            <label class="btn btn-primary" onclick="delivery_notice(2);">
                                                <input name="type_id" value="2" type="radio" autocomplete="off">
                                                бесплатная
                                            </label>
                                            ...
                                            <label class="btn btn-primary" onclick="delivery_notice(4);">
                                                <input name="type_id" value="4" type="radio" autocomplete="off"> зависит
                                                от
                                                заказа
                                            </label>
                                            <label class="btn btn-primary" id="region_check"
                                                   ...
                                                   style="display:none">
                                                <input type="radio" name="type_id" value="5" autocomplete="off">
                                                уточнить
                                            </label>
                                            <label class="btn btn-primary" onclick="delivery_notice(1);">
                                                <input type="radio" name="type_id" value="1" autocomplete="off">
                                                отсутствует
                                            </label>
                                        </div>
                                        <br><br>
                                ...
                                <tr>
                                    <td colspan="2" align="right">
                                        <div class='delivery_options' style="display:none" id='button_delivery'><input
                                                    class="btn btn-primary" type="submit" value="Добавить"/></div>
                                    </td>
                                </tr>
                            </table>
                        </div>
            ...
            <div class="card-block">
                <p>
                    <label><input type="checkbox" value=1
                                  name="f_post" <?= isset($checked_f_post) ? $checked_f_post : "" ?> id="f_post"/>
                        Доставка
                        почтой
                        возможна</label>
                </p>
                    ...
                    <form method="POST" id="frmAdd" action="/seller/place-actions">
                        ...
                        <div class="col-lg-12" style="overflow: auto">
                            <table class="table" style="width: 100%">
                                ...
                                <tr>
                                    <td colspan="2" align="right"><input class="btn btn-primary" type="submit"
                                                                         value="Добавить"
...
<div id="myModal" class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header"><h5 class="modal-title" id="modal-title">Редактировать информацию о доставке</h5>
