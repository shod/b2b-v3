...
<div class="wcontent">
    ...
    <p style="margin-bottom: 10px; color:red;">Ваш аккаунт отключен.<br> Для возобновления следует обратиться в отдел по работе с клиентами.</p>
    <p>
        Тел: +375 29 <b>111-45-45</b> (Velcom)  <br>
    </p>
</div>
