...
<div class="row">
    <div class="col-lg-12">
        <div class="card card-block">
            ...
            <div style="background-color:#b8f8b8">3 -  <a href="/balance/add">Баланс пополнить</a></div>
            <div style="background-color:#b8f8b8">5 - <a href="/balance/akt">Баланс выгрузка актов</a></div>
            <div style="background-color:#b8f8b8">11 - <a href="/order/sms">SMS заказы</a></div>
            <div style="background-color:#b8f8b8">12 - <a href="/product/on-sale">Товары в продаже</a></div>
            <div style="background-color:#b8f8b8">13 - <a href="/product/catalog">Редактирование товаров в разделе</a></div>
            <div style="background-color:#b8f8b8">25 - <a href="/statistic/cost-analysis">Анализ цен конкурентов</a></div>
            ...
            <div>4 - <a href="/balance/promise">Баланс обещаный платех</a></div>
            <div>6 - <a href="/balance/report">Баласн Финансовый отчет</a></div>
            ...
            <div>24. <a href="/banner-spec">Баннерные спецпредложения</a></div>
            <div>25. <a href="/banner-spec/add">Баннерные спецпредложения добавление</a></div>
        </div>
    </div>
</div>
