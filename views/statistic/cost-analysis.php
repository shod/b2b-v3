                    ...
                    <div class="col-lg-12">
                        <form id="analysis_form" method='get' class="form-inline">
                            ...
                            <select name="wh_state" class="form-control">
                                ...
                                <option value="1" <?= isset($wh_state_1) ? $wh_state_1 : "" ?> >В наличии</option>
                                <option value="2" <?= isset($wh_state_2) ? $wh_state_2 : "" ?> >Под заказ</option>
                                <option value="3" <?= isset($wh_state_3) ? $wh_state_3 : "" ?> >Отсутствует</option>
                            </select>

                            <input class="form-control" type="text" name="basic_name"
                                   value="<?= isset($basic_name) ? $basic_name : "" ?>" placeholder="Название товара">
                            ...
                            <div class="input-group input-group-sm">
                                ...
                                <input class="form-control" type="text" id="sids" name="sids"
                                       value="<?= isset($sids) ? $sids : "" ?>" placeholder="исключить ID магазинов">
                            </div>
        ...
        <div class="ks-nav-body">
            <div class="ks-nav-body-wrapper">
                <div class="container-fluid" style="overflow: auto">
                    <table id="ks-datatable" class="table table-striped table-bordered" width="100%" data-height="500">
                        <thead>
                        <tr>
